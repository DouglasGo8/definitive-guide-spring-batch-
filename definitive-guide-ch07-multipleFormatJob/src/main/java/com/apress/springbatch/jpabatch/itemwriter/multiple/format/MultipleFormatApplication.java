package com.apress.springbatch.jpabatch.itemwriter.multiple.format;

import com.apress.springbatch.jpabatch.itemwriter.multiple.format.batch.TransactionFieldSetMapper;
import com.apress.springbatch.jpabatch.itemwriter.multiple.format.domain.Customer;
