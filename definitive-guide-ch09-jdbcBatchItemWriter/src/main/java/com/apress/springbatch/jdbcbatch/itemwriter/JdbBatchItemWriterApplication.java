package com.apress.springbatch.jdbcbatch.itemwriter;

import com.apress.springbatch.jdbcbatch.itemwriter.domain.Customer;
import com.apress.springbatch.jdbcbatch.itemwriter.domain.CustomerItemPreparedStatementSetter;
...
public class JdbBatchItemWriterApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(JdbBatchItemWriterApplication.class, args);
    }
}
